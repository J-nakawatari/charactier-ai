...
export default function Sidebar() {
  ...
  return (
    <div className="fixed h-screen w-64 bg-white border-r border-gray-100 flex flex-col shadow-sm">
      {/* ヘッダー */}
      <div className="p-6 border-b border-gray-200">
        <div className="flex items-center space-x-3">
          <div className="w-10 h-10 bg-gradient-to-br from-purple-500 via-purple-600 to-pink-500 rounded-xl flex items-center justify-center">
