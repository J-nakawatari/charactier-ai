    ...
    <div className={`bg-white rounded-lg shadow-sm border p-6 ${
      ...
      <div className="space-y-3">
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-600">{t('totalPurchased')}</span>
        ...
        <div className="flex items-center justify-between text-sm">
          <span className="text-gray-600">{t('dailyAverage')}</span>
        ...
        {estimatedDaysLeft > 0 && (
          <div className="flex items-center justify-between text-sm">
            <span className="text-gray-600">{t('estimatedDaysLeft')}</span>
            <span className={`font-medium ${
              isLowWarning ? 'text-red-600' : 'text-gray-900'
            }`}>
{t('aboutDays', { days: estimatedDaysLeft })}
            </span>
          </div>
        )}
      </div>
