...
export const config = {
  ...
  matcher: [
    ...
    // Enable redirects that add missing locales, but exclude API routes, admin routes, webhook, and static files
    '/((?!_next|_vercel|api|admin|webhook|sitemap\\.xml|robots\\.txt|.*\\..*).*)'
  ]
};